...
/* The software page walker; fallback for accelerators overriding the op */
MMUTranslateResult mmu_gva_to_gpa_walk(CPUState *cpu, target_ulong gva, uint64_t *gpa, MMUTranslateFlags flags);
