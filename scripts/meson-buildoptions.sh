...
meson_options_help() {
  ...
  printf "%s\n" '                           reaudio/default/dsound/jack/libretro/oss/pa/pipew'
  printf "%s\n" '                           ire/sdl/sndio)'
  ...
  printf "%s\n" '                           firmware]'
  printf "%s\n" '  --glib=CHOICE            How to find the glib library [system] (choices:'
  printf "%s\n" '                           internal/system)'
  ...
  printf "%s\n" '  --zlib=CHOICE            How to find the zlib library [system] (choices:'
  printf "%s\n" '                           internal/system)'
  printf "%s\n" ''
  ...
  printf "%s\n" '  libretro        libretro core support'
...
_meson_option_parse() {
  case $1 in
    ...
    --enable-libretro) printf "%s" -Dlibretro=enabled ;;
    --disable-libretro) printf "%s" -Dlibretro=disabled ;;
