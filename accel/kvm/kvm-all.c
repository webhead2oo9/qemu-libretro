 ...
 * PA space for the LFB write-merge buffer. Taken verbatim from the
 * upstream qemu-3dfx patch: a transient RAMBlock funnels the raw range
 * through kvm_set_phys_mem().
 */
